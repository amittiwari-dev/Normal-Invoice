        ...
        <div class="container">
            ...
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <form method="POST" action="{{ route('client.data.edit') }}">
                                @csrf
                                <div class="form-group">
                                    <label class="control-label mb-10" for="exampleInputuname_1"> Client Name </label>
                                    <div class="input-group">

                                        <input type="text" value="{{ $client->name }}" class="form-control" name="name" id="exampleInputuname_1"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" class="form-control"  value="{{ $client->phone }}" name="mobile"
                                            placeholder="Enter Mobile">

                                        <input type="text" hidden class="form-control"  value="{{ $client->id }}" name="id"
                                            placeholder="Enter Mobile">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" name="address" placeholder="Enter Address">{{ $client->address }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" name="description" placeholder="If Need Any Description">{{ $client->msg }}</textarea>
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-primary mr-10">Edit Client</button>
